...
% Make the deck compile both from inside final_presentation/ (latexmk here)
% and from the repository root (e.g. an Overleaf project containing the whole
% repo with this file selected as the main document).
\graphicspath{{./}{final_presentation/}}
\IfFileExists{references.bib}
  {\newcommand{\bibfile}{references}}
  {\newcommand{\bibfile}{final_presentation/references}}
...
\begin{frame}{Phase II --- One Global Factor Summarises Eleven Local Ones}
  \centering
  \includegraphics[width=0.82\linewidth]{figures/s5_gcf.pdf}
  \begin{itemize}
...
\begin{frame}{Appendix: Out-of-Sample Summary Table}
  \centering
  \includegraphics[width=0.8\linewidth]{tables/mr_t4_oos.pdf}
\end{frame}
...
\begin{frame}{Appendix: Robustness --- Subsample Stability}
  \centering
  \includegraphics[width=0.75\linewidth]{figures/rob_f1_oos_sub.pdf}\\[1ex]
  \includegraphics[width=0.75\linewidth]{figures/rob_f2_oos_scheme.pdf}
\end{frame}

...
\begin{frame}{Motivation}
  ...
  \end{equation*}
  \alert{Yet bond returns \emph{are} predictable} --- risk premia vary over time:
  \begin{enumerate}
    ...
    \item \citet{cieslak2015}: splitting yields into \emph{trend inflation} and
      \emph{cycles}, the cycle factor predicts returns --- a macro-anchored
      mechanism.
    \item \citet{dahlquist2013}: a \emph{global} CP factor predicts international
      returns better than local factors alone --- bond markets are integrated.
  \end{enumerate}
  \vfill

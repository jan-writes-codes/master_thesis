...
\begin{frame}{Appendix: Robustness --- Trend-Parameter Sensitivity}
  \centering
  \includegraphics[width=0.8\linewidth]{figures/rob_f4_dma_sens.pdf}\\[0.5ex]
  {\footnotesize Trend inflation rebuilt under every $(v, M)$ combination,
   $v \in \{0.900, 0.987, 0.995\}$, $M \in \{60, 120, 180\}$;
   baseline $v=0.987$, $M=120$.}
\end{frame}

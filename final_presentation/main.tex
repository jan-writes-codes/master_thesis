...
\begin{frame}{Phase III: The FX adjustment only helps modestly}
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
    ...
    \begin{column}{0.48\textwidth}
      \begin{itemize}
        ...
        \item Average $R^{2}$: $8\%\to10\%$, uniform in direction but small in
          magnitude
        \item $\FXGCF$ and $\GCF$ correlate \textbf{0.99} here (far above
    ...
    \begin{column}{0.48\textwidth}
      \begin{itemize}
        ...
        \item \textbf{USD investor:} $\GCF$ at $-0.07$, while $\FXGCF$ turns it
          marginally positive ($+0.002$, 9 of 11 markets)
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Robustness}
  ...
  \begin{itemize}
    ...
    \item The $\FXGCF$ edge is concentrated post-crisis, fragile dependent on the expanding window and does not survive a
